            ...
            <table class="table table-bordered table-hover table-striped">
                ...
                <tbody id="myTable">
                    ...
                    <tr>
                        ...
                        <td><?php echo 'Ksh ' .$order['price']; ?></td>
                        ...
                        <td>
                            <a href="javascript:void(0);" onclick="deleteOrder(<?php echo $order['o_id']; ?>)" class="btn btn-danger"> <i class="fas fa-trash-alt"></i> Cancel</a>
                             ...
                             <a href="javascript:void(0);" onclick="pay(<?php echo $order['price']; ?>)" class="btn btn-success"> <i class="fas fa-money-alt"></i>Pay Now</a>
...
<script>
    ...
    function pay(total)
    {
        ...
        window.location.href = '<?php echo base_url().'checkout/pay/';?>' + total;
        } 
    }
</script>