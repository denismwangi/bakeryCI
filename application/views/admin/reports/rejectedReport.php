...
<body class="bg-white">
    ...
    $(document).ready(function() {
        ...
        <div class="col-md-6 mt-3" style="margin-left: 30%;">
            <div class="row">
                <div class="col-md-12">
                    <h2>Dishes Report</h2>
                </div>
                <div class="col-md-12">
                    <table class="table table-striped table-responsive table-hover">
                        ...
                        <tbody id="myTable">
                            <?php if(!empty($rejectedReport)) {?>
                            <?php foreach($rejectedReport as $report) { ?>
                            <tr>
                                <td><?php echo $report->d_id; ?></td>
                                <td><?php echo $report->d_name; ?></td>
                                <td><?php echo 'Ksh ' .$report->price; ?></td>
                ...
                <div class="col-md-12">
                    <a href="<?php $id=3; echo base_url().'admin/home/generate_pdf/'.$id; ?>"
