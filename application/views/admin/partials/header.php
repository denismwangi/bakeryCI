            ...
            <div class="collapse navbar-collapse" id="navbarRes">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown active">
                     ...
                     <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="<?php echo base_url().'admin/home/rejected_orders/';?>"><i class="fas fa-line-chart"></i> Rejected</a>
                          
                            <a class="dropdown-item" href="<?php echo base_url().'admin/home/resReport';?>"><i class="fas fa-line-chart"></i> Restaurants Reports</a>
                    
                            <a class="dropdown-item" href="<?php echo base_url().'admin/home/dishesReport';?>"><i class="fas fa-line-chart"></i> Dishes Reports</a>
                        </div>
                    </li>
