...
class Home extends CI_Controller {
    ...
    {
        $rej = $this->Order_model->rejectedOrders();
        $data['rejectedReport'] = $rej;
        $this->load->view('admin/reports/rejectedReport', $data);
    ...
    public function generate_pdf($id) {
        ...
        {
            $this->table->set_heading('Id', 'Dish name', 'total number of times dish ordered');
            $dishReport = $this->Order_model->rejectedOrders();
            foreach ($dishReport as $sf):
                $this->table->add_row($sf->d_id, $sf->d_name, $sf->price ,$sf->quantity);
            endforeach; 
